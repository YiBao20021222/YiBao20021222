    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (var i = 0; i < res.length; i++) {
                array_res.push([res[i].score, 3, 3, res[i].teacher_name, res[i].student_id + ":" + res[i].student_name]);
            }
                        ...
                        transform: [
                            {
                                ...
                                config: {
                                    resultDimensions: [
                                        ...
                                        { name: '成绩期望', from: '成绩', method: 'median' },
                ...
                series: [
                    {
                        ...
                        encode: {
                            x: ['最小成绩', 'Q1', '成绩期望', 'Q3', '最大成绩'],
                            y: '老师',
                            itemName: ['老师'],
                            tooltip: ['最小成绩', 'Q1', '成绩期望', 'Q3', '最大成绩']
                        }
                    },
                    {
                        name: '具体学生分布',
